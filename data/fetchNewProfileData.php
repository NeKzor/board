...
//    $data = Database::query("SELECT users.profile_number AS player_id, IFNULL(steamname, boardname) as displayName FROM users WHERE profile_number = 76561198057533306");

...
class Discord {
    private static $username = 'aptag.board.portal2.sr';
    private static $avatar = 'https://raw.githubusercontent.com/NeKzor/board/aptag/public/images/portal2boards_avatar.png';
    private static $embed_icon = 'https://raw.githubusercontent.com/NeKzor/board/aptag/public/images/portal2boards_icon.png';
    ...
    public static function sendMdpWebhook($data, $demoName, $text, $err = null) {
        try {
            ...
            $payload = [
                ...
                'content' => 'Link to change log: [Click Here](<https://aptag.board.portal2.sr/changelog?id='.$data['id'].'>)'
            ];
            ...
            curl_setopt($ch, CURLOPT_USERAGENT, 'aptag.board.portal2.sr');
    ...
    public static function buildEmbed($data) {
        $embed = [
            'title' => $data['map'],
            'url' => 'https://aptag.board.portal2.sr/chamber/'.$data['map_id'],
            'color' => 295077,
            'thumbnail' => [
                'url' => 'https://raw.githubusercontent.com/NeKzor/board/aptag/public/images/thumbnails/'.$data['map_id'].'.jpg',
            ],
            'fields' => [
                [
                    'name' => 'WR',
                ...
                [
                    'name' => 'By',
                    'value' => '['.self::sanitiseText($data['player']).'](<https://aptag.board.portal2.sr/profile/'.$data['player_id'].'>)',
                    'inline' => true
                ],
            ]
        ];
